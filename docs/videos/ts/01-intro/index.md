...
这样你就能对 TypeScript 有大体的认识了，也能编写简单的 TypeScript 应用并且看懂一部分其他人的代码了。到这里你可能发现 TypeScript 带来的功能特性都是零散的，因为它本身就是给 JS 添砖加瓦，所以它的语法点逐一突破就好了。后期看视频情况继续出一些高级特性的视频，比如class、枚举、面向对象、泛型、装饰器等等。好了，如果觉得视频有帮助,请点赞并关注，我是二姨，感谢观看！